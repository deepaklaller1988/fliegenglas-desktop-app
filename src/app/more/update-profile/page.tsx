                ...
                <div className="w-full">
                    <div className="form-view">
                        <div className="w-full">
                            ...
                            <div className="w-full">
                                <b className="text-white mt-2 block">Hast Du eine neue E-Mail Adresse? Gib sie hier ein:</b>
                                <input type="email" className="my-3 bg-white text-black rounded-md p-3 h-[50px] w-full" />
