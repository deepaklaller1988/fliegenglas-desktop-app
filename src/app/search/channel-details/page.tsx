...
export default function ChannelDetails() {
    ...
    const mutation: any = useMutation({
        mutationFn: async () => {
            ...
            const response = await fetch(
                `addFav?&channel_id=${channelId}&user_id=${user?.id}&fav=${favStatus}&time=${new Date().toString()}`,
                // {
    ...
    const getAllCategories = async (channelId: string,isRefreshing: boolean = false) => {
        try {
            ...
            <div className="rightSideSet">
                ...
                <div className="w-full p-5 py-20 text-center">
                    ...
                    <p className="text-white text-sm">
                        {isLiked ? "Diese Hörbuch-Kategories wird direkt auf der App-Startseite angezeigt."
