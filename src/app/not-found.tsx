  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-4  w-full">
      <div className="text-center">
        ...
        <button className="w-6/12 ml-32 float-left text-center text-white cursor-pointer border border-white font-sansbutton yellow w-6/12	rounded-md h-[50px]" onClick={handleGoBack}>
          Go Back
        </button>
      </div>
    </div>
